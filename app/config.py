...
class Settings:
    ...
    AI_WORKER_BASE_URL: str = os.getenv(
        "AI_WORKER_BASE_URL", "http://192.168.60.110:8000"
    )
    DB_STORAGE_BASE_URL: str = os.getenv(
        "DB_STORAGE_BASE_URL", "http://192.168.60.112"
    )
    WEB_SERVER_BASE_URL: str = os.getenv(
        "WEB_SERVER_BASE_URL", "http://192.168.60.111"
    )
